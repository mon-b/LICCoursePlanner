...
const resources = {
  en: {
    translation: {
      ...
      prerequisiteCredits: "You need to have accumulated at least {{credits}} credits previously",
      prerequisiteOr: "or",
  ...
  es: {
    translation: {
      ...
      prerequisiteCredits: "Necesitas haber acumulado al menos {{credits}} créditos previamente",
      prerequisiteOr: "o",
